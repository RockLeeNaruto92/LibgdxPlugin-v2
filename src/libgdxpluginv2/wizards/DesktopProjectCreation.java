...
public class DesktopProjectCreation {
	...
	public String create() {
		...
		modifyClasspathFile();
		modifyProjectFile();
		return path + "/" + projectName + Constant.EXTENSION_DESKTOP + "/"
				+ Constant.PATTERN_PROJECT_FILE;
	}

	private void createDesktopProjectFolder() {
		// TODO Auto-generated method stub
		String desktopFolderPath = path + "/" + projectName
				+ Constant.EXTENSION_DESKTOP;
		String patternAndroidFolderPath = Constant.PATTERN_FOLDER + "/"
				+ Constant.PATTERN_DESKTOP_FOLDER;
		File desktopFolder;
		File patternFolder;
	...
	private String createSrcStructure() {
		String srcPath = path + "/" + projectName + Constant.EXTENSION_DESKTOP
				+ "/src";
	...
	private void modifyJavaFile(String srcPath) {
		...
		String javaFilePatternPath = path + "/" + projectName
				+ Constant.EXTENSION_DESKTOP + "/"
				+ Constant.PATTERN_MAIN_DESKTOP_CLASS_FILE;
