...
public class CoreProjectCreation {
	...
	private void createCoreProjectFolder() {
		...
		String patternCoreFolderPath = Constant.PATTERN_FOLDER + "/"
				+ Constant.PATTERN_CORE_FOLDER;
		URL patternCoreFolderUrl = Platform.getBundle(Constant.BUNDLE_NAME)
				.getEntry(patternCoreFolderPath);
		File coreFolder;
		File patternFolder;
	...
	private void modifyJavaFile(String srcPath) {
		...
		String javaFilePatternPath = path + "/" + projectName + "/"
				+ Constant.PATTERN_MAIN_CLASS_FILE;
	...
	private void modifyGwtFile() {
		String gwtFilePath = path + "/" + projectName + "/"
				+ Constant.PATTERN_GWT_XML_FILE;
		String destFilePath = path + "/" + projectName + "/src/" + projectName
				+ ".gwt.xml";
