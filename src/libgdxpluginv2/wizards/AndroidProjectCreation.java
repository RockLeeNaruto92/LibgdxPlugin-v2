...
public class AndroidProjectCreation {
	...
	public String create() {
		...
		modifyProjectFile();
		modifyClasspathFile();
		return path + "/" + projectName + Constant.EXTENSION_ANDROID + "/"
				+ Constant.PATTERN_PROJECT_FILE;
	}

	private void createAndroidProjectFolder() {
		// TODO Auto-generated method stub
		String androidFolderPath = path + "/" + projectName
				+ Constant.EXTENSION_ANDROID;
		String patternAndroidFolderPath = Constant.PATTERN_FOLDER + "/"
				+ Constant.PATTERN_ANDROID_FOLDER;
		File androidFolder;
		File patternFolder;
		Utility.createFolder(androidFolderPath);
		androidFolder = new File(androidFolderPath);
		patternFolder = Utility
				.getPluginResourcesFile(patternAndroidFolderPath);
		try {
	...
	private String createSrcStructure() {
		String srcPath = path + "/" + projectName + Constant.EXTENSION_ANDROID
				+ "/src";
	...
	private void modifyJavaFile(String srcPath) {
		...
		String javaFilePatternPath = path + "/" + projectName
				+ Constant.EXTENSION_ANDROID + "/"
				+ Constant.PATTERN_MAIN_ANDROID_CLASS_FILE;
		String destJavaFilePath = srcPath + "/"
				+ Constant.PATTERN_MAIN_ANDROID_CLASS_FILE;
		...
		try {
			...
			System.out.println("Not found " + javaFilePatternPath + " or "
					+ destJavaFilePath);
		}
		srcFile.delete();
		// End move
		...
		String newContent = content.replaceAll(Constant.PATTERN_PROJECT_NAME,
				projectMainClass);
		newContent = newContent.replaceAll(Constant.PATTERN_MAIN_PACKAGE,
				projectMainPackage);
		try {
	...
	private void modifyManifestFile() {
		// TODO Auto-generated method stub
		String manifestFilePath = path + "/" + projectName
				+ Constant.EXTENSION_ANDROID + "/"
				+ Constant.ANDROID_MANIFEST_XML_FILE;
		...
		content = content.replaceAll(Constant.PATTERN_MAIN_PACKAGE,
				projectMainPackage);
		try {
	...
	private void modifyProjectFile() {
		// TODO Auto-generated method stub
		// modify file project
		String projectFilePath = path + "/" + projectName
				+ Constant.EXTENSION_ANDROID + "/"
				+ Constant.PATTERN_PROJECT_FILE;
		...
		content = content
				.replaceAll(Constant.PATTERN_PROJECT_NAME, projectName);
		try {
			FileUtils.writeStringToFile(file, content);
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	private void modifyClasspathFile() {
		// TODO Auto-generated method stub
		String classPathFilePath = path + "/" + projectName
				+ Constant.EXTENSION_ANDROID + "/"
				+ Constant.PATTERN_CLASS_PATH_FILE;
